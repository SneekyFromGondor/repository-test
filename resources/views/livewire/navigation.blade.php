      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4 focus:outline-none">
            ...
            @foreach($razas as $r)
            <a href="{{route('viajes.raza', $r)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$r->nombre}}</a>
            @endforeach
            <a href="{{route('viajes.cachorrxs')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Cachorros</a>
          </div>
        </div>
      </div>
      @auth
